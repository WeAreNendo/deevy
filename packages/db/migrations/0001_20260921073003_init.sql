-- Generated from drizzle/20260921073003_init/migration.sql by `vp run db#generate:d1`.
...
CREATE INDEX `issue_externalUpdatedAt_idx` ON `issue` (`external_updated_at`);
